###Bias from bivariate, univariate and derived estimation under a multiplicative error model based on linear regression 
###this program can reproduce simulations results in Table S5 of Web Appendix E
###author: Zhiqiang Cao
...
for(scenario in scenario_set){
  ...
  write.csv(round(bias_b1_res,3), paste0('multiplicative_bias_b1_',scenario,'.csv'))
  write.csv(round(bias_b2_res,3), paste0('multiplicative_bias_b2_',scenario,'.csv'))
}
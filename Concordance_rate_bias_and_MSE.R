###Concordance rate, bias and MSE of naive estimation, univariate estimation and derived estimation
###and RC estimation
###this program can reproduce simulations results in Table 7 of main text
###author: Zhiqiang Cao
